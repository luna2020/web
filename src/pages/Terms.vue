    ...
    <div class="container">
      <div class="columns">
        <div class="column is-offset-3 is-6">
          <h1 class="title is-1 is-spaced"> Terms of Service<span class="spacer is-horizontal is-1"></span><span class="tag is-primary">Website</span> </h1>
          <h2 class="subtitle is-5"> Last Update: November 14, 2018 </h2>
          <div class="message is-primary">
            <div class="message-body">
              <p> <strong>Heads up!</strong> Are you looking for our <a href="/privacy-app"><u>mobile app privacy policy</u></a>? </p>
            </div>
          </div>
          <div class="content is-medium">
            ...
            <h2> Web &amp; Social Media </h2>
            <h3> Contacting Us </h3>
            <p> If you contact us by means of a form on the website or by e-mail, your data will be stored for a period of 12 months in order to process the request and in case of follow-up questions. We will not share this information without your consent. </p>
            <h3> Cookies </h3>
            ...
            <p> If you have any questions or concerns about our privacy policies, please contact us: <a href="mailto:studio@littlelightsstudio.com" target="_blank">studio@littlelightsstudio.com</a> / <a href="mailto:support@getbedtimestories.com" target="_blank">support@getbedtimestories.com</a>. </p>
            <h2> Changes to our privacy policy </h2>
            <p> This privacy policy was last updated on November 14, 2018. Our privacy policy may change from time to time, and we explicitly reserve our right to do so. If we make any material changes to our policies, we will place a prominent notice on our website or application. </p>
          </div>
        </div>
      </div>
    </div>
