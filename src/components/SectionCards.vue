<template>
<section class="section is-storyworlds has-background">
  <div class="container">
    <div class="columns is-centered">
      <div class="column is-9 is-8-widescreen">
        <div class="columns is-multiline" id="grid">
          <div class="column is-6 is-6-widescreen is-flex" data-groups="[&quot;9-12&quot;]">
            <div class="card is-storyworld"> <a class="card-header" href="/library/the-mystery-on-utopus">
          ...
          <div class="column is-6 is-6-widescreen is-flex" data-groups="[&quot;2-4&quot;]">
            <div class="card is-storyworld"> <a class="card-header" href="/library/brenda-and-her-big-dog-duke">
